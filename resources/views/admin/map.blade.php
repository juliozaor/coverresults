                    ...
                    <div class="d-flex flex-column flex-shrink-0 aside-search">
                        <div class="container-rounded mb-3">
                            ...
                            <ul class="nav nav-pills flex-column mb-auto">
                                <li class="nav-item">
                                    <a href="#" class="nav-link bg-danger d-flex text-white align-items-center justify-content-between mb-2" data-alert-type="pulseless">
                                        <img src="{{ asset('assets/dist/img/location_no.svg') }}"/>
                                        Disconnected <span class="badge bg-white text-danger" id="pulseless-count">{{ $pulselessCount }}</span>
                                        <small>See all</small>
                                    </a>
                                </li>
                                
                                <li class="nav-item">
                                    <a href="#" class="nav-link bg-primary text-white align-items-center d-flex justify-content-between mb-2" data-alert-type="out_of_location">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                setInterval(function() {
                    fetch(`{{ url('api/devices/locations') }}`) // Usar la URL correcta
                        .then(response => {
                            if (!response.ok) {
                        ...
                        .then(text => {
                            try {
                                ...
                                console.log('Response text:', text); // Mostrar el texto de la respuesta para depuración
                            }
                        })
                        .catch(error => {
